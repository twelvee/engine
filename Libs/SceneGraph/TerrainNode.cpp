      ...
      LightMapTexture(NULL)
{
    ...
    for (unsigned long LMElemNr=0; LMElemNr<3*Pow2NrOfLightMapPatches*Pow2NrOfLightMapPatches; LMElemNr++) LightMap.PushBack(static_cast<unsigned char>(0xFF));;
