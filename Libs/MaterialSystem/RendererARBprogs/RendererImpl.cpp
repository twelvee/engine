...
void RendererImplT::Initialize()
{
    ...
    char GrayData[]={ static_cast<char>(128), static_cast<char>(128), static_cast<char>(128), 0 };
    ...
    char LightBlueData[]={ static_cast<char>(0x80), static_cast<char>(0x80), static_cast<char>(0xFF), 0 };
