...
void ParentFrameT::OnShow(wxShowEvent& SE)
{
    if (SE.IsShown() && m_RendererDLL==NULL)
    {
        ...
        char Data[]={ static_cast<char>(255), static_cast<char>(255), static_cast<char>(255), static_cast<char>(255), static_cast<char>(255), static_cast<char>(255), 0, 0,
                      static_cast<char>(255), static_cast<char>(255), static_cast<char>(255), static_cast<char>(255), static_cast<char>(255), static_cast<char>(255), 0, 0 };
